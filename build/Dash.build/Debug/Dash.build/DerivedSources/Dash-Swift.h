...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dash",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4Dash15DashAppDelegate")
...
SWIFT_CLASS_NAMED("DownloadItem")
...
@class NSUUID;
@class NSDate;
@interface DownloadItem (SWIFT_EXTENSION(Dash))
...
SWIFT_CLASS("_TtC4Dash15DownloadManager")
...
@class NSURL;
@class NSData;
@interface DownloadManager (SWIFT_EXTENSION(Dash)) <WKDownloadDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC4Dash14GhostTextField")
@interface GhostTextField : NSTextField
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("HistoryItem")
@interface HistoryItem : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface HistoryItem (SWIFT_EXTENSION(Dash))
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSDate * _Nullable timestamp;
...
@interface Item (SWIFT_EXTENSION(Dash))
@property (nonatomic, copy) NSDate * _Nullable timestamp;
@end
